...
_Status: Verified & Production Ready | Timezone: Asia/Kolkata (IST, UTC+5:30)_
...
| `custom`     | _User selected_           | `YYYY-MM-DD 00:00:00 IST` $\to$ `(YYYY-MM-DD + 1) 00:00:00 IST` | Custom interval      |
