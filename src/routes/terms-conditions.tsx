    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
        ...
        <p>
          ...
          specifications, and details of the products available on our website. However, we do not
        ...
        <p>
          We accept payments through Razorpay, which includes Credit Cards, Debit Cards, Net
          Banking, UPI, and wallets. You agree to provide current, complete, and accurate purchase
          and account information for all purchases made via the website. You further agree to
        ...
        <p>
          All prices are subject to change without notice. We reserve the right at any time to
          modify or discontinue the Service (or any part or content thereof) without notice at any
          time. We shall not be liable to you or to any third-party for any modification, price
