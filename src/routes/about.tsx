...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About Zerah Baby And Kids — Gentle Essentials for Little Ones" },
      { property: "og:description", content: "How a parent-run baby store curates and safety-tests every product." },
...
const values = [
  { icon: Leaf, title: "Gentle materials", text: "Organic cotton, food-grade silicone and water-based paints come first." },
  { icon: ShieldCheck, title: "Tested twice", text: "Every batch is lab-checked, then trialled by our own parent panel." },
  { icon: Heart, title: "Honest pricing", text: "No inflated MRPs — the discount you see is the discount you get." },
  { icon: Users, title: "Parent support", text: "Real humans on chat, seven days a week, from 8am to 9pm." },
];
