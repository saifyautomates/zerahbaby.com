  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
        ...
        <p>
          You can cancel your order at any time before it has been dispatched from our warehouse. To
          cancel your order, please contact our support team with your order number. Once the order
          has been shipped, it cannot be cancelled, but it may be eligible for a return.
        </p>
        ...
        <p>
          ...
          satisfied, we accept returns within 7 days of the delivery date, provided the items are
          unused, in their original packaging, and in the same condition that you received them.
        </p>

        <h2 className="text-xl font-semibold text-foreground mt-8">3. Non-Returnable Items</h2>
        <p>Certain items cannot be returned for hygiene and safety reasons. These include:</p>
        ...
        <p>
          ...
          automatically be applied to your original method of payment (e.g., via Razorpay) within
          5-7 business days. Please note that shipping costs are non-refundable.
        </p>
        ...
        <p>
          ...
          with photos of the defect. We will arrange for a replacement or a full refund, including
