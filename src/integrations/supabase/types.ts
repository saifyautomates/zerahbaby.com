  ...
  public: {
    Tables: {
      ...
      inventory_transactions: {
        Row: {
          ...
          transaction_type:
            | Database["public"]["Enums"]["inventory_tx_type"]
            | null
      ...
      offline_returns: {
        Row: {
          ...
          credit_token_status: string | null
          credit_used: number
      ...
      pos_cart_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "pos_cart_sessions_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "pos_customers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pos_cart_sessions_offline_sale_id_fkey"
      ...
      pos_exchange_vouchers: {
        ...
        Relationships: [
          {
            foreignKeyName: "pos_exchange_vouchers_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "pos_customers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pos_exchange_vouchers_return_id_fkey"
            columns: ["return_id"]
            isOneToOne: false
            referencedRelation: "offline_returns"
            referencedColumns: ["id"]
      ...
      pos_session_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "pos_session_items_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pos_session_items_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "pos_cart_sessions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "pos_session_items_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
            referencedRelation: "product_variants"
            referencedColumns: ["id"]
      ...
      store_credit_ledger: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "store_credit_ledger_source_sale_id_fkey"
    ...
    Views: {
      pos_store_credit_ledger: {
        ...
        Insert: {
          ...
          return_id?: never
          sale_id?: never
          source_return_id?: never
          source_sale_id?: never
          type?: string | null
          used_in_sale_id?: never
        }
        Update: {
          amount?: number | null
          balance_after?: number | null
    ...
    Functions: {
      ...
      admin_hard_delete_offline_returns: {
        Args: { _return_ids: string[]; _revert_stock?: boolean }
        Returns: Json
      }
      admin_hard_delete_offline_sales: {
        Args: { _restore_stock?: boolean; _sale_ids: string[] }
        Returns: Json
      }
      ...
      admin_toggle_homepage_section_visibility: {
        Args: { p_is_visible: boolean; p_section_id: string }
        Returns: boolean
      }
      ...
      admin_void_offline_sale: {
        Args: { _reason?: string; _restore_stock?: boolean; _sale_id: string }
        Returns: Json
      }
      ...
      close_pos_session: { Args: { p_session_id: string }; Returns: undefined }
      ...
      generate_unique_exchange_credit_token: { Args: never; Returns: string }
      get_active_pos_sessions: { Args: never; Returns: Json }
      get_admin_queries: {
      ...
      is_homepage_admin: { Args: never; Returns: boolean }
      ...
      save_pos_session_full: {
        Args: { p_items?: Json; p_session: Json }
        Returns: Json
      }
