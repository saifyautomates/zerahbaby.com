...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'C:/Users/jackx/.gemini/antigravity-ide/brain/2baa45ed-6154-4f36-9e15-b150c8f89d14/scratch/razorpay-success.png' });
  } catch (e) {
    console.log("Razorpay modal did not open or timed out.");
    await page.screenshot({ path: 'C:/Users/jackx/.gemini/antigravity-ide/brain/2baa45ed-6154-4f36-9e15-b150c8f89d14/scratch/razorpay-error.png' });
    console.error(e);
  }
