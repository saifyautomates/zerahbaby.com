-- ==============================================================================
-- Migration: 20260928000011_permanent_pos_return_and_customer_fix.sql
-- Description:
-- 1. Ensure pos_customers has total_spend, total_spent, total_purchases, total_visits, store_credit_balance
-- 2. Cleanly recreate single canonical process_offline_return RPC
-- ==============================================================================

-- 1. pos_customers schema robustness
ALTER TABLE public.pos_customers ADD COLUMN IF NOT EXISTS store_credit_balance numeric DEFAULT 0;
ALTER TABLE public.pos_customers ADD COLUMN IF NOT EXISTS total_spend numeric DEFAULT 0;
ALTER TABLE public.pos_customers ADD COLUMN IF NOT EXISTS total_spent numeric DEFAULT 0;
ALTER TABLE public.pos_customers ADD COLUMN IF NOT EXISTS total_purchases integer DEFAULT 0;
ALTER TABLE public.pos_customers ADD COLUMN IF NOT EXISTS total_visits integer DEFAULT 0;
