-- ==============================================================================
-- Migration: 20260928000183_canonical_process_offline_return_single_source.sql
-- Description:
-- Fix process_offline_return to use the exact matching offline_returns schema
-- and eliminate double-restocking on product_variants items.
-- ==============================================================================
