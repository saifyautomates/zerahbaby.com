-- =====================================================================
-- Migration: 20260928000240_fix_product_costs_column_and_place_offline_sale.sql
-- Description: Add cost_price alias column to public.product_costs and
--              update place_offline_sale to safely query COALESCE(cost_price, buying_price, 0).
-- =====================================================================

-- 1. Ensure cost_price and buying_price both exist on public.product_costs
...
SET cost_price = COALESCE(cost_price, buying_price, 0),
    buying_price = COALESCE(buying_price, cost_price, 0);

-- 2. Update place_offline_sale to use COALESCE(cost_price, buying_price, 0)
