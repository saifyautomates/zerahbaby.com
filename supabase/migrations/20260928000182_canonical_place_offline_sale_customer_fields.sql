-- ==============================================================================
-- Migration: 20260928000182_canonical_place_offline_sale_customer_fields.sql
-- Description:
-- Fix pos_customers columns in place_offline_sale to match schema:
-- (total_spent, total_spend, visits_count, total_visits, total_purchases, last_visit, last_visit_date)
-- ==============================================================================
