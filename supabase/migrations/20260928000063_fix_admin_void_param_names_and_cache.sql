-- Migration: 20260928000063_fix_admin_void_param_names_and_cache.sql
-- Match exact frontend parameter names (_sale_id, _reason, _restore_stock) and reload PostgREST schema cache

DROP FUNCTION IF EXISTS public.admin_void_offline_sale(uuid, text, boolean) CASCADE;

-- 1. Canonical function with _sale_id, _reason, _restore_stock
...
-- 2. Compatibility forwarder for admin_delete_offline_sale
