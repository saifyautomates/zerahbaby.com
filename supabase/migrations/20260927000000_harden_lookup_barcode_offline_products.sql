-- ==============================================================================
-- Migration: Harden Barcode Lookup for Offline-Only Products & Variant-less Items
-- Description: Ensures lookup_barcode works seamlessly for:
--              1. Products with variants (matching variant barcode/SKU or parent barcode/SKU)
--              2. Products WITHOUT variants (matching parent barcode, SKU, slug, or ID)
--              3. Products with sales_channel = 'OFFLINE_ONLY' or 'ONLINE_AND_OFFLINE'
-- ==============================================================================
