-- =============================================================================
-- Migration: 20260928000138_fix_finalize_paid_order_session_lookup.sql
-- Fix checkout session resolution in finalize_paid_order:
-- 1. Support lookup by session_id (text), checkout_sessions.id (uuid), or via payment_attempts.checkout_session_id
-- 2. Insert into public.payments record upon finalization
-- 3. Maintain strict idempotency and lock protection
-- =============================================================================
...
BEGIN
  -- 1. Idempotency Check: if order already exists for this payment or order, return it immediately
  ...
  -- 9. Update payment attempt status to captured
  ...
  -- 10. Record payment in public.payments table
