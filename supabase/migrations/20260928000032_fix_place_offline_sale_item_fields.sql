-- Migration: 20260928000032_fix_place_offline_sale_item_fields.sql
-- Description: Add product_slug to recordset in place_offline_sale and grant store_credit_ledger read

GRANT SELECT ON public.store_credit_ledger TO anon, authenticated;
DROP POLICY IF EXISTS "allow select store_credit_ledger" ON public.store_credit_ledger;
CREATE POLICY "allow select store_credit_ledger" ON public.store_credit_ledger FOR SELECT TO public USING (true);
