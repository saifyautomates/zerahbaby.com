-- Migration: 20260928000233_fix_offline_sales_customer_email_nullable.sql
-- Description: Drop NOT NULL constraint on offline_sales.customer_email (and customer_phone/notes)
-- and update place_offline_sale RPC to safely handle empty/omitted customer emails for walk-in sales.

-- 1. Ensure columns on offline_sales are nullable with sensible defaults
ALTER TABLE public.offline_sales ALTER COLUMN customer_email DROP NOT NULL;
ALTER TABLE public.offline_sales ALTER COLUMN customer_email SET DEFAULT '';

ALTER TABLE public.offline_sales ALTER COLUMN customer_phone DROP NOT NULL;
ALTER TABLE public.offline_sales ALTER COLUMN customer_phone SET DEFAULT '';

ALTER TABLE public.offline_sales ALTER COLUMN notes DROP NOT NULL;
ALTER TABLE public.offline_sales ALTER COLUMN notes SET DEFAULT '';

ALTER TABLE public.offline_sales ALTER COLUMN customer_name DROP NOT NULL;
ALTER TABLE public.offline_sales ALTER COLUMN customer_name SET DEFAULT 'Walk-in Customer';

-- 2. Update place_offline_sale RPC to handle customer_email, customer_phone, and notes safely
...
-- 3. Maintain strictly restricted execution permissions
