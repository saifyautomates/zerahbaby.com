-- ============================================================================
-- Migration: 20260928000318_enforce_variant_stock_bounds.sql
-- Purpose:
--   Enforce non-negative, non-null stock at the authoritative admin variant
--   stock RPC boundary.
-- ============================================================================
...
BEGIN
  ...
  IF _new_stock IS NULL OR _new_stock < 0 THEN
    RAISE EXCEPTION 'Stock level cannot be negative or null';
  END IF;
