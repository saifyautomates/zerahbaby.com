-- Migration: 20260928000179_fix_pos_authorization_and_catalog_channels.sql
-- Description:
-- 1. Restore robust POS terminal authorization check in place_offline_sale and grant execution to anon, authenticated, and service_role.
-- 2. Set 'cord' product sales_channel to 'ONLINE_AND_OFFLINE' so storefront /shop has active products.
-- 3. Seed essential products with variants (romper, wooden-rattle, baby-wash) across primary categories.
...
BEGIN
  ...
  -- Only reject when an explicit non-staff authenticated user attempts unauthorized POS execution
...
GRANT EXECUTE ON FUNCTION public.place_offline_sale(text, text, text, text, text, text, numeric, uuid, jsonb, text, numeric, text, text) TO anon, authenticated, service_role;

-- 2. Update 'cord' product sales_channel to ONLINE_AND_OFFLINE
UPDATE public.products
SET sales_channel = 'ONLINE_AND_OFFLINE', is_active = true
WHERE slug = 'cord';

-- 3. Seed verified primary products with variants across categories
-- 3.1 Romper (Clothing)
INSERT INTO public.products (
  id, slug, name, brand, category, description, sku, price, mrp, stock, is_active, sales_channel
) VALUES (
  ...
  'Zérah',
  'clothing',
  'Ultra-soft 100% GOTS-certified organic cotton romper with snap closures.',
  'ZR-CL-ROMP',
  499,
  799,
  60,
  ...
  is_active = true,
  stock = GREATEST(products.stock, 50);

-- Variants for romper
INSERT INTO public.product_variants (
  id, product_id, name, color, size, sku, stock, price_override, mrp_override, is_active
) VALUES
  ('11111111-1111-4111-8111-222222222201', '11111111-1111-4111-8111-111111111111', '0-6M White', 'White', '0-6M', 'ZR-ROMP-WHT-06', 20, 499, 799, true),
  ('11111111-1111-4111-8111-222222222202', '11111111-1111-4111-8111-111111111111', '6-12M White', 'White', '6-12M', 'ZR-ROMP-WHT-12', 20, 499, 799, true),
  ('11111111-1111-4111-8111-222222222203', '11111111-1111-4111-8111-111111111111', '12-24M Sage', 'Sage Green', '12-24M', 'ZR-ROMP-SGE-24', 20, 549, 849, true)
ON CONFLICT (id) DO UPDATE SET stock = GREATEST(product_variants.stock, 20), is_active = true;

-- 3.2 Wooden Sensory Rattle (Toys)
INSERT INTO public.products (
  id, slug, name, brand, category, description, sku, price, mrp, stock, is_active, sales_channel
) VALUES (
  '22222222-2222-4222-8222-222222222222',
  'wooden-rattle',
  'Natural Wooden Sensory Rattle',
  'Zérah Kids',
  'toys',
  'Smooth beechwood rattle with non-toxic food-grade finish.',
  'ZR-TY-RATL',
  349,
  499,
  35,
  ...
  sales_channel = 'ONLINE_AND_OFFLINE',
  is_active = true,
  stock = GREATEST(products.stock, 30);

-- Default variant for wooden-rattle
INSERT INTO public.product_variants (
  id, product_id, name, sku, stock, price_override, mrp_override, is_active
) VALUES (
  ...
  499,
  true
) ON CONFLICT (id) DO UPDATE SET stock = GREATEST(product_variants.stock, 30), is_active = true;

-- 3.3 Pediatric Baby Wash (Care)
INSERT INTO public.products (
  id, slug, name, brand, category, description, sku, price, mrp, stock, is_active, sales_channel
) VALUES (
  '33333333-3333-4333-8333-333333333333',
  'baby-wash',
  'Ultra-Gentle Pediatric Wash 200ml',
  'Zérah Care',
  'care',
  'Tear-free hypoallergenic wash with organic calendula and chamomile extracts.',
  'ZR-CR-WASH',
  299,
  399,
  40,
  ...
  sales_channel = 'ONLINE_AND_OFFLINE',
  is_active = true,
  stock = GREATEST(products.stock, 35);

-- Default variant for baby-wash
INSERT INTO public.product_variants (
  id, product_id, name, sku, stock, price_override, mrp_override, is_active
) VALUES (
  ...
  399,
  true
) ON CONFLICT (id) DO UPDATE SET stock = GREATEST(product_variants.stock, 35), is_active = true;

-- 3.4 Ensure t-shirt exists for legacy test suites
INSERT INTO public.products (
  id, slug, name, brand, category, description, sku, price, mrp, stock, is_active, sales_channel
) VALUES (
  ...
  'Zérah',
  'clothing',
  'Breathable organic cotton daily t-shirt with soft crew neck.',
  'ZR-CL-TSHIRT',
  399,
  599,
  50,
  ...
  sales_channel = 'ONLINE_AND_OFFLINE',
  is_active = true,
  stock = GREATEST(products.stock, 40);

INSERT INTO public.product_variants (
  id, product_id, name, color, size, sku, stock, price_override, mrp_override, is_active
) VALUES (
  '44444444-4444-4444-8444-555555555501',
  '44444444-4444-4444-8444-444444444444',
  '0-6M Blue',
  'Sky Blue',
  '0-6M',
  ...
  599,
  true
) ON CONFLICT (id) DO UPDATE SET stock = GREATEST(product_variants.stock, 40), is_active = true;
