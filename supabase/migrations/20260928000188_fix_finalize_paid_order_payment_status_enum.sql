-- ==============================================================================
-- Migration: 20260928000188_fix_finalize_paid_order_payment_status_enum.sql
-- Description:
-- In finalize_paid_order: Insert 'paid'::public.payment_status instead of 'success'
-- into public.payments.status, aligning with the PostgreSQL enum definition.
-- ==============================================================================
