-- Migration: 20260928000180_seed_25_omnichannel_products.sql
-- Description:
-- Seed 25 premium boutique products across all 8 categories with sales_channel = 'ONLINE_AND_OFFLINE'
-- Populates products, product_images, and product_variants for omnichannel POS + Storefront operation.
