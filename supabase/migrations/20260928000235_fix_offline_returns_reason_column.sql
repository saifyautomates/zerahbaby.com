-- Migration: 20260928000235_fix_offline_returns_reason_column.sql
-- Description: Ensure all reason/return_reason, status, and expiry columns exist on public.offline_returns
-- and update process_offline_return RPC to safely populate them.

-- 1. Ensure all column variations exist on offline_returns
