-- =============================================================================
-- Migration: 20260928000132_fix_payment_attempts_status_check.sql
-- 1. Expand payment_attempts_status_check to allow 'completed' and 'captured'
-- 2. Use 'captured' in finalize_paid_order
-- =============================================================================

-- 1. Update check constraint on payment_attempts
...
-- 2. Update finalize_paid_order to use 'captured'
