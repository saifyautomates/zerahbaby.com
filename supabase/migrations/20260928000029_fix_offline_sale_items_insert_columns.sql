-- Migration: 20260928000029_fix_offline_sale_items_insert_columns.sql
-- Description: Align offline_sale_items INSERT with actual table schema (remove non-existent custom_price column).
...
BEGIN
  ...
  LOOP
    ...
    -- Insert sale line item with exact columns present in offline_sale_items
