-- Migration: 20260928000028_fix_offline_sale_items_column_name.sql
-- Description: Fix column name sale_id in offline_sale_items INSERT statement.
...
BEGIN
  ...
  LOOP
    ...
    -- Insert sale line item using canonical column name sale_id
