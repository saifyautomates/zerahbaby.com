-- =====================================================================
-- Migration: 20260928000259_canonical_place_offline_sale_coupon_columns.sql
-- Description: Canonical update of place_offline_sale to strictly use
--              valid_from and valid_until from public.coupons table,
--              handling uncapped max discount (0 or NULL) and usage limits.
-- =====================================================================
