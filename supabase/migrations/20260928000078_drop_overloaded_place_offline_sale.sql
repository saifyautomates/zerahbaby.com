-- ==============================================================================
-- Migration: 20260928000078_drop_overloaded_place_offline_sale.sql
-- Description: Drop all overloaded variations of place_offline_sale and define
--              the canonical single signature.
-- ==============================================================================

DROP FUNCTION IF EXISTS public.place_offline_sale(text,text,text,text,text,text,numeric,uuid,numeric,text,text,jsonb,text);
