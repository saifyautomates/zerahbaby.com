-- Migration: 20260928000026_fix_unassigned_record_in_place_offline_sale.sql
-- Description: Replace unassigned record access with scalar variables (v_token_id, v_token_balance) in place_offline_sale.
