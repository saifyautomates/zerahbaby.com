-- Migration: 20260928000036_add_sale_id_to_store_credit_ledger.sql
-- Description: Add sale_id to store_credit_ledger and ensure place_offline_sale writes CREDIT_USED

ALTER TABLE public.store_credit_ledger ADD COLUMN IF NOT EXISTS sale_id uuid;
