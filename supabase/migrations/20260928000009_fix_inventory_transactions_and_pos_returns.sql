-- ==============================================================================
-- Migration: 20260928000009_fix_inventory_transactions_and_pos_returns.sql
-- Description:
-- 1. Ensure offline_return_items has unit_mrp and mrp_snapshot columns
-- 2. Fix process_offline_return RPC to accurately write to inventory_transactions table
--    using canonical columns (product_id, type, quantity, previous_quantity, new_quantity, reference_type, reference_id, note, created_by)
-- ==============================================================================

-- 1. Ensure schema compatibility for offline_return_items
DO $$
BEGIN
  IF NOT EXISTS (
...
-- 2. Permanent Fix for process_offline_return RPC
